    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
          <a class="btn btn-danger" style="margin-left: 10px; margin-top: 10px;" data-toggle="modal" data-target="#ModalEdit">LAPORAN <span class="fa fa-file"></span></a>
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <!-- <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $i->id;?>">ceklis<span class="fa fa-pencil"></span></a> -->
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/pasien/update'?>" method="post" enctype="multipart/form-data">
