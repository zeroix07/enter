            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <a class="btn" placeholder="Kirim Email" data-toggle="modal" data-target="#ModalEdit<?php echo $i->id;?>"><span class="fa fa-envelope"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7"> 
                          <input type="text" name="deskripsi" class="form-control" id="inputUserName" value="" placeholder="Deskripsi" required>
                        </div>
                      </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/peserta/hapus'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="id" value="<?php echo $id;?>"/>
                            <p>Yakin anda akan menghapus <?php echo $nama;?></p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Email Berhasil dikirim ke penerima.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
