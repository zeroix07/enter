  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Cek Dokter</li>
      </ol>
    </section>
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <a class="btn btn-primary" data-toggle="modal" data-target="#ModalEdit<?php echo $i->id;?>">SELESAI <span class="fa fa-check"></span></a>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/rawat/update'?>" method="post" enctype="multipart/form-data">
